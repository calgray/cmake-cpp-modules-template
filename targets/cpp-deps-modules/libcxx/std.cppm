...
#if CXX_MODULE_STD
// std already exists, have to export something
export module libcxx;
export import std;
#else // CXX_MODULE_STD
...
#include <deque>
#include <exception>
#if __has_include(<execution>) & _LIBCPP_ENABLE_EXPERIMENTAL
#include <execution>
...
// #include "std/strstream.inc"  deprecated
